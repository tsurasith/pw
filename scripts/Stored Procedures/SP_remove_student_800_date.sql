/*
    ...
    Stored procedure: remove_student_800_date
    ...
    call remove_student_800_date('2023-01-16');
...
DROP PROCEDURE IF EXISTS `remove_student_800_date`;



DELIMITER //
CREATE PROCEDURE `remove_student_800_date` (
...
BEGIN
    ...
    DELETE FROM teachers_800     WHERE check_date    = removing_date;

    DELETE FROM student_800      WHERE check_date   = removing_date;
    DELETE FROM student_800_task WHERE task_date = removing_date;    
    ...
    WHERE
        ...
        (
            ...
            WHERE
                ...
                student_id in
                (
                    select distinct student_id FROM student_800
                    WHERE
