...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
    <tr> 
      <td width="6%" align="center"><a href="index.php?option=module_800/index"><img src="../images/modules/800_clock2.png" alt=""  border="0"/></a></td>
      <td ><strong><font color="#990000" size="4">8.00 O' Clock</font></strong><br />
        <span class="normal"><font color="#0066FF"><strong>2.5 แผนภูมิเปรียบเทียบการเข้าร่วมกิจกรรมหน้าเสาธง<br/>(กราฟพื้นที่เลือกห้องเรียน)</strong></font></span></td>
      <td >
    ...
    <tr > 
		<td align="center">
			<?php
				...
				echo renderChart("../fusion/Charts/MSLine.swf", "", $_strXML , "absent", 700, 600);
				echo $_strXML;
			?>
		</td>
    </tr>
