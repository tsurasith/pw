...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="10" class="header">
  <tr>
	...
	<span class="normal">ข้อมูลส่วนตัว | 
			<a href="index.php?option=module_profile/changeprofile">แก้ไขข้อมูลส่วนตัว</a> |
			<a href="index.php?option=module_profile/changepassword">เปลี่ยนรหัสผ่าน</a></span></td>
    <td width="100px">&nbsp;</td>
  </tr>
</table>
<?php
...
<table width="100%" align="center" cellspacing="1" class="admintable">
	...
	<tr>
		<td rowspan="12" width="160px" valign="top" align="center" class="key"><br/>
			<img src="../images/teacphoto/TC<?=$_dat['TeacCode']?>.jpg" width="140px" height="180px" alt="รูปภาพที่ใช้ในระบบ" />
			<br/>
			<a href="index.php?option=module_profile/teacherEditPic&teacher_code=<?=$_dat['TeacCode']?>">เปลี่ยนรูปภาพ</a>
		</td>
