<div id="content">
 <table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
    <tr> 
      ...
      <td width="55%"><strong><font color="#990000" size="4">TCSS</font></strong><br />
      ...
      <td >
		...
		เลือกแบบประเมิน </font>
		  	<select name="content" onChange="this.form.submit()" class="inputboxUpdate">
				...
				<option value="eq" <?=$_POST['content']=="eq"   || $_REQUEST['content']=="eq"?"selected":""?>> งานประเมิน EQ</option>
				<option value="stress" <?=$_POST['content']=="stress" || $_REQUEST['content']=="stress"?"selected":""?>>งานประเมินความเครียด</option>
				<option value="moral" <?=$_POST['content']=="moral"   || $_REQUEST['content']=="moral"?"selected":""?>>งานประเมินภาวะซึมเศร้า</option>
				<option value="game" <?=$_POST['content']=="game"     || $_REQUEST['content']=="game"?"selected":""?>>งานประเมินการติดเกมส์</option>
			</select>
  ...
  ?>
    <table width="100%" align="center" cellspacing="1" class="admintable">
		...
		<tr>
			<td width="2px">&nbsp;</td>
			<td><a href="index.php?option=module_tcss/studentList&type=student">1.1 บันทึกข้อมูลนักเรียนประเมินตนเอง (นักเรียนเป็นผู้ประเมิน)</a></td>
		</tr>
		<tr>
			<td width="2px">&nbsp;</td>
			<td><a href="index.php?option=module_tcss/studentList&type=parent">1.2 บันทึกข้อมูลผู้ปกครองประเมินนักเรียน (ผู้ปกครองเป็นผู้ประเมิน)</a></td>
		</tr>
		<tr>
			<td width="2px">&nbsp;</td>
			<td><a href="index.php?option=module_tcss/studentList&type=teacher">1.3 บันทึกการประเมินนักเรียน (ครูเป็นผู้ประเมิน)</a></td>
		</tr>
		<tr> 
...
<? } else { ?>
				<table width="100%" align="center" cellspacing="1" class="admintable">
					<tr><td class="key" colspan="2">ระบบดูแลช่วยเหลือโรงเรียนเพชรวิทยาคาร</td></tr>
					<tr>
							<td width="2px">&nbsp;</td>
							<td> &nbsp; &nbsp; 
