...
<div id="content">
	<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
			<tr> 
				...
				<td width="64%"><strong><font color="#990000" size="4">การจัดการหลักสูตรและการสอน</font></strong><br />
					<span class="normal"><font color="#0066FF"><strong>2.4 แสดงรายวิชาตามโครงสร้างแผนการเรียนและสรุปหน่วยการเรียน (รูปแบบ 2)</strong></font></span>
				</td>
				<td >
					ปีการศึกษา <?=$acadyear?>
		...
		if(isset($_POST['search'])){
			...
			for($_i=0;$_i<3;$_i++){
				$_sql[$_loop] = "
					...
					where
						c.curriculum_id = '" . $_curriculum_id . "' and s.SubjectLevel = '" . $_year[$_i] . "' ";
	...
	<? if($_rows_result > 0){ ?>
		...
		<br/><br/>
			<table class="admintable">
				<tr height="45px">
					<td colspan="8" class="key" align="center">
						<font size="4">
						โครงสร้างแผนการเรียน <?=$_curr_display_name?>
						</font>
					</td>
				</tr>
				<?for($_i=0;$_i<3;$_i++){ ?>
					...
					<tr>
						...
						<td class="key" align="center" width="170px">ชื่อวิชา</td>
							...
							<table>
								...
								<? while($_dat = mysqli_fetch_assoc($_res)){ ?> 
										...
										<tr <?=$_bg_color?>>
											...
											<td valign="top" width="170px" ><?=$_dat['SubjectName']?></td>
						...
						<td align="center" class="key">
							<b>
								<?
									...
									echo number_format($_total_unit_term_1[$_i],1);
								?>
							</b>
						</td>
						<td align="center" class="key">
						...
						<td align="center" class="key">
							<b>
								<?
									...
									echo number_format($_total_unit_term_2[$_i],1);
								?>
							</b>
						</td>
						<td align="center" class="key">
			...
			<table class="admintable">
				...
				<tr>
						<td class="key" rowspan="2" align="center" width="60px">ระดับชั้น</td>
						<td valign="top" class="key" align="center" colspan="3">ภาคเรียนที่ 1</td>
						<td valign="top" class="key" align="center" colspan="3">ภาคเรียนที่ 2</td>
					</tr>
					<tr>
						<td class="key" align="center" width="220px">ประเภทวิชา</td>
						<td class="key" align="center" width="50px">หน่วยกิต</td>
						<td class="key" align="center" width="50px">ชั่วโมง</td>
						<td class="key" align="center" width="220px">ประเภทวิชา</td>
						<td class="key" align="center" width="50px">หน่วยกิต</td>
				...
				<?for($_i=0;$_i<3;$_i++){ ?>
					<tr>
						<td align="center" class="key" rowspan="4">
							<font size="4">ม. <?=$_year[$_i]?></font>
						</td>
						<td style="padding-left:22px;">สาระการเรียนรู้พื้นฐาน</td>
						<td align="center"><?=number_format($_total_subject_type_1_unit_term_1[$_i],1)?></td>
						<td align="center"><?=$_total_subject_type_1_hour_term_1[$_i]?></td>
						<td style="padding-left:22px;">สาระการเรียนรู้พื้นฐาน</td>
						<td align="center"><?=number_format($_total_subject_type_1_unit_term_2[$_i],1)?></td>
						<td align="center"><?=$_total_subject_type_1_hour_term_2[$_i]?></td>
					</tr>
					<tr>
						<td style="padding-left:22px;">สาระการเรียนรู้เพิ่มเติม</td>
						<td align="center"><?=number_format($_total_subject_type_2_unit_term_1[$_i],1)?></td>
						<td align="center"><?=$_total_subject_type_2_hour_term_1[$_i]?></td>
						<td style="padding-left:22px;">สาระการเรียนรู้เพิ่มเติม</td>
						<td align="center"><?=number_format($_total_subject_type_2_unit_term_2[$_i],1)?></td>
						<td align="center"><?=$_total_subject_type_2_hour_term_2[$_i]?></td>
					</tr>
					<tr>
						<td style="padding-left:22px;">สาระกิจกรรมพัฒนาผู้เรียน</td>
						<td align="center"><?=number_format($_total_subject_type_3_unit_term_1[$_i],1)?></td>
						<td align="center"><?=$_total_subject_type_3_hour_term_1[$_i]?></td>
						<td style="padding-left:22px;">สาระกิจกรรมพัฒนาผู้เรียน</td>
						<td align="center"><?=number_format($_total_subject_type_3_unit_term_2[$_i],1)?></td>
						<td align="center"><?=$_total_subject_type_3_hour_term_2[$_i]?></td>
					</tr>
					<tr height="30px">
						<td class="key" style="padding-left:22px;">รวมหน่วยการเรียน/ชั่วโมง ม. <?=$_year[$_i]?></td>
						<td align="center" class="key">
							<b>
								<?
									$_total_unit_term_1[$_i] = $_total_subject_type_1_unit_term_1[$_i]+$_total_subject_type_2_unit_term_1[$_i]+$_total_subject_type_3_unit_term_1[$_i];
						...
						<td class="key" style="padding-left:22px;">รวมทั้งหมด</td>
						<td align="center" class="key">
							<b>
								<?
									$_total_unit_term_2[$_i] = $_total_subject_type_1_unit_term_2[$_i]+$_total_subject_type_2_unit_term_2[$_i]+$_total_subject_type_3_unit_term_2[$_i];
				...
				<tr height="35px">
					<td class="key"></td>
					<td class="key" style="padding-left:22px;">รวมหน่วยการเรียน/ชั่วโมง ทุกปี</td>
					<td align="center" class="key">
						<b>
							<?
								echo number_format(array_sum($_total_unit_term_1),1);
							?>
						</b>
					</td>
					<td align="center" class="key">
						<b>
							<?php
								echo array_sum($_total_hour_term_1);
							?>
						</b>
					</td>
					<td class="key" style="padding-left:22px;">รวมทั้งหมด</td>
					<td align="center" class="key">
						<b>
							<?
								echo number_format(array_sum($_total_unit_term_2),1);
							?>
						</b>
					</td>
					<td align="center" class="key">
						<b>
							<?php
								echo array_sum($_total_hour_term_2);
							?>
						</b>
					</td>
				</tr>
