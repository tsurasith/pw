...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
	...
	<span class="normal"><font color="#0066FF"><strong>2.2.1 รายงานสรุปกิจกรรมโครงการตามประเภทงบประมาณ</strong></font></span></td>
      <td >
		<?php
		...
		?>
		ปีการศึกษา<?php  
					echo "<a href=\"index.php?option=module_projects/xReportMoneyYear&acadyear=" . ($acadyear - 1) . "\"><img src=\"../images/pull_left.gif\" border=\"0\" /></a> " ;
					echo ' <font color=\'blue\'>' .$acadyear . '</font>';
					echo "<a href=\"index.php?option=module_projects/xReportMoneyYear&acadyear=" . ($acadyear + 1) . "\"> <img src=\"../images/pull_right.gif\" border=\"0\" /></a> " ;
				?>
...
<? } else { ?>
		<? $_sql = "select a.acadsemester,a.project_id,a.project_name,a.finish_date,a.purpose,a.budget_income,
					  sum(b.money) as money,a.budget_income-sum(b.money) as total
					from project a left outer join project_budget b
					on (a.project_id = b.project_id)
					where acadyear = '" . $acadyear . "' and  a.budget_type = '" . $_POST['budgetType'] . "'
		...
		<table class="admintable" width="100%" align="center" >
			<tr>
				<th colspan="6" align="center">
					...
					<br/>
					รายงานเงินงบประมาณที่ใช้จ่ายในกิจกรรม/โครงการ<br/>
					สรุปตาม <?=$_POST['budgetType']=="00"?"เงินงบประมาณ":"เงินอุดหนุนอื่น"?>  ปีการศึกษา <?=$acadyear?>
				</td>
			</tr>
			<tr>
			...
			<tr onMouseOver="this.style.backgroundColor='#FFCCFF'; this.style.cursor='hand';" onMouseOut=this.style.backgroundColor="#FFFFFF" >
				...
				<td>
					<a href="index.php?option=module_projects/projectFull&p_id=<?=$_dat['project_id']?>&acadyear=<?=$acadyear?>&acadsemester=<?=$_dat['acadsemester']?>">
					<?=$_dat['project_name']?>
					</a>
				</td>
