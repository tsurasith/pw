...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
	...
	<span class="normal"><font color="#0066FF"><strong>2.2.6 รายงานสรุปกิจกรรมโครงการ<br/>ตามมาตรฐานและตัวชี้วัด(เรียงตามมาตรฐาน)</strong></font></span></td>
      <td >
		<?php
		...
		?>
		ปีการศึกษา<?php  
					echo "<a href=\"index.php?option=module_projects/xReportStandardYear&acadyear=" . ($acadyear - 1) . "\"><img src=\"../images/pull_left.gif\" border=\"0\" /></a> " ;
					echo ' <font color=\'blue\'>' .$acadyear . '</font>';
					echo " <a href=\"index.php?option=module_projects/xReportStandardYear&acadyear=" . ($acadyear + 1) . "\"><img src=\"../images/pull_right.gif\" border=\"0\" /></a> " ;
				?>
		<br/>
