	...
	<table class="admintable" width="100%">
		<tr>
			<td align="center" height="150px">
				<form method="post">
					<font color="#FF0000">
					คุณต้องการที่จะลบตัวชี้วัด ออกจากกิจกรรม/โครงการนี้ "ใช่" หรือ "ไม่"<br/>
					...
					<input type="hidden" name="organize" value="<?=$_REQUEST['organize']?>" />
					<input type="hidden" name="indexof" value="<?=$_REQUEST['indexof']?>" />
