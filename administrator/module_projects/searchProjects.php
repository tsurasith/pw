	...
	<div align="center">
		<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
			<tr> 
				...
				<span class="normal"><font color="#0066FF"><strong>?.สืบค้นโครงการ</strong></font></span></td>
				<td align="right">
					<?php
					...
					?>
					ปีงบประมาณ <?php  
								echo "<a href=\"index.php?option=module_projects/searchProjects&acadyear=" . ($acadyear - 1) . "\"><img src=\"../images/pull_left.gif\" border=\"0\" /></a> " ;
								echo '<font color=\'blue\'>' .$acadyear . '</font>';
								echo " <a href=\"index.php?option=module_projects/searchProjects&acadyear=" . ($acadyear + 1) . "\"><img src=\"../images/pull_right.gif\" border=\"0\" /></a> " ;
							?>
				</td>
			</tr>
		</table>
