...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
	...
	<span class="normal"><font color="#0066FF"><strong>2.2.4 รายงานสรุป ปัญหาและข้อเสนอแนะ<br/> กิจกรรมโครงการ</strong></font></span></td>
      <td >
		<?php
		...
		?>
		ปีการศึกษา<?php  
					echo "<a href=\"index.php?option=module_projects/xReportProblemYear&acadyear=" . ($acadyear - 1) . "\"><img src=\"../images/pull_left.gif\" border=\"0\" /></a> " ;
					echo ' <font color=\'blue\'>' .$acadyear . '</font>';
					echo " <a href=\"index.php?option=module_projects/xReportProblemYear&acadyear=" . ($acadyear + 1) . "\"><img src=\"../images/pull_right.gif\" border=\"0\" /></a> " ;
				?>
		<font size="2" color="#000000">
			<form method="post" autocomplete="off">
				<? $_res = mysqli_query($_connection,"select project_id,project_name from project where acadyear = '" . $acadyear . "' order by acadsemester"); ?>
