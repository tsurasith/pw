  ...
  <table class="admintable" width="100%" cellpadding="1" cellspacing="1" border="0" align="center">
    <tr> 
      <th  align="center">
			...
			รายการข้อมูลค่าน้ำหนักเฉลี่ยของนักเรียนโรงเรียนเพชรวิทยาคาร<br/>
...
<? } else { //end-if check_submit ?>  
		<? $_sql = "select id,prefix,firstname,lastname,xlevel,xyearth,room,weight from students where xEDBE = '" .$acadyear."' " . (isset($_POST['studstatus'])=="1,2"?"and studstatus in (1,2)":"");?>
		<table align="center" class="admintable" width="100%">
			<tr>
				<td colspan="6" class="key" align="center">
					<img src="../images/school_logo.png" width="120px"><br/>
					รายชื่อนักเรียนที่มีน้ำหนักมากที่สุด 10 อันดับแรกของโรงเรียนเพชรวิทยาคาร<br />ปีการศึกษา <?=$acadyear?>
				</td>
			</tr>
			<tr>
