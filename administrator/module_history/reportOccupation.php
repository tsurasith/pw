...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
    <tr> 
      ...
      <td ><strong><font color="#990000" size="4">สืบค้นประวัติ</font></strong><br />
        <span class="normal"><font color="#0066FF"><strong>2.2.3 รายชื่อนักเรียนอาชีพบิดา มารดา<br/>และผู้ปกครอง (รายห้องเรียน)</strong></font></span></td>
      <td >
	  <?php
		...
		?>
		ปีการศึกษา<?php  
					echo "<a href=\"index.php?option=module_history/reportOccupation&acadyear=" . ($acadyear - 1) . "\"><img src=\"../images/pull_left.gif\" border=\"0\" /></a> " ;
					echo '<font color=\'blue\'>' .$acadyear . '</font>';
					echo " <a href=\"index.php?option=module_history/reportOccupation&acadyear=" . ($acadyear + 1) . "\"><img src=\"../images/pull_right.gif\" border=\"0\" /></a> " ;
				?>
		ภาคเรียนที่   <?php 
					if($acadsemester == 1) { echo "<font color='blue'>1</font> , "; }
					else {
						echo " <a href=\"index.php?option=module_history/reportOccupation&acadyear=" . ($acadyear) . "&acadsemester=1 \"> 1</a> , " ;
					}
					if($acadsemester == 2) { echo "<font color='blue'>2</font>"; }
					else {
						echo " <a href=\"index.php?option=module_history/reportOccupation&acadyear=" . ($acadyear) . "&acadsemester=2 \"> 2</a> " ;
					}
				?>
		</font>
		<br/>
  ...
  <table class="admintable" width="100%" cellpadding="1" cellspacing="1" border="0" align="center">
    <tr> 
      <th colspan="10" align="center">
			...
			ข้อมูลอาชีพบิดา มารดา และผู้ปกครองนักเรียนห้อง <?=getFullRoomFormat($_POST['roomID'])?><br/>
    ...
    <tr> 
		...
		<td class="key" align="center" colspan="3">อาชีพ</td>
	</tr>
		<td class="key" width="110px" align="center">บิดา</td>
		<td class="key" width="110px" align="center">มารดา</td>
		<td class="key" width="110px" align="center">ผู้ปกครอง</td>
    </tr>
	<?php
		$sqlStudent = "select id,prefix,firstname,lastname,studstatus,f_status,m_status,f_occupation,m_occupation,a_occupation
						from students 
