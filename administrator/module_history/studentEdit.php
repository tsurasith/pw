			...
			<tr>
				<td>
					<?php
						...
						$_sqlUpdate .= "education_loan1 =	'" . (is_numeric(trim($_POST['education_loan1']))?trim($_POST['education_loan1']):0) . "',";
						$_sqlUpdate .= "education_loan2 =	'" . (is_numeric(trim($_POST['education_loan2']))?trim($_POST['education_loan2']):0) . "',";
						$_sqlUpdate .= "education_loan3 =	'" . (is_numeric(trim($_POST['education_loan3']))?trim($_POST['education_loan3']):0) . "',";
						...
						$_sqlUpdate .= "HowLong =	'" . (is_numeric(trim($_POST['HowLong']))?trim($_POST['HowLong']):0) . "',";
