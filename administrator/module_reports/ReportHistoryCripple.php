...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
    <tr> 
      ...
      <td><strong><font color="#990000" size="4">ระบบรายงาน/สถิติ</font></strong><br />
        <span class="normal"><font color="#0066FF"><strong>1.6.6 สารสนเทศนักเรียนตามสถานภาพความพิการ</strong></font></span></td>
      <td >
		<?php
		...
		?>
		ปีการศึกษา<?php  
					echo "<a href=\"index.php?option=module_reports/ReportHistoryCripple&acadyear=" . ($acadyear - 1) . "\"><img src=\"../images/pull_left.gif\" border=\"0\" /></a> " ;
					echo ' <font color=\'blue\'>' .$acadyear . '</font>';
					echo " <a href=\"index.php?option=module_reports/ReportHistoryCripple&acadyear=" . ($acadyear + 1) . "\"><img src=\"../images/pull_right.gif\" border=\"0\" /></a> " ;
				?>
		<br/>
		...
		<table class="admintable" width="100%" align="center" >
			<tr>
				<th colspan="2" align="center">
					...
					<br/>
					สารสนเทศนักเรียนตามสถานภาพความพิการ
					...
					<table align="center" >
						...
						<tr>
							...
							<? while($_dat = mysql_fetch_assoc($_result)) { ?>
								...
								<? $_xmlPie .= "<set value='" . ($_dat['male']+$_dat['female']) . "' name='" .($_dat['cripple']==""?"ไม่ระบุ":displayCripple($_dat['cripple'])). "' color='" . $_color . "'/>"; ?>
								<? $_m += $_dat['male']; $_f +=$_dat['female']; $_t += $_dat['total']; ?>
								<tr>
									<td align="left" style="padding-left:15px;"><?=$_dat['cripple']==""?"ไม่ระบุ":displayCripple($_dat['cripple'])?></td>
