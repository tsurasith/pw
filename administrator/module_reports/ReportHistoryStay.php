...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
    <tr> 
      ...
      <td><strong><font color="#990000" size="4">ระบบรายงาน/สถิติ</font></strong><br />
        <span class="normal"><font color="#0066FF"><strong>1.6.1 สารสนเทศนักเรียนตามการพักอาศัย<br/>ของนักเรียนและเพศ</strong></font></span></td>
      <td width="55%">
		<?php
		...
		?>
		ปีการศึกษา<?php  
					echo "<a href=\"index.php?option=module_reports/ReportHistoryStay&acadyear=" . ($acadyear - 1) . "\"><img src=\"../images/pull_left.gif\" border=\"0\" /></a> " ;
					echo ' <font color=\'blue\'>' .$acadyear . '</font>';
					echo " <a href=\"index.php?option=module_reports/ReportHistoryStay&acadyear=" . ($acadyear + 1) . "\"><img src=\"../images/pull_right.gif\" border=\"0\" /></a> " ;
				?>
		<br/>
...
<? if(isset($_POST['search']) && $_POST['roomID'] =="") { ?>
	<? echo "<br/><br/><center><font color='red'>กรุณาเลือก ระดับชั้น ที่ต้องการทราบข้อมูลก่อน</font></center>";} ?>	
<? if(isset($_POST['search']) && $_POST['roomID'] != ""){ ?>
		...
		<table class="admintable" width="100%" align="center" >
			<tr>
				<th colspan="2" align="center">
					...
					<br/>
					สารสนเทศนักเรียนตามการพักอาศัยของนักเรียน 
			...
			<tr>
				<td colspan="2" align="center">
					<table align="center" >
						<tr>
							<td class="key" rowspan="2" align="center" width="220px">การพักอาศัย</td>
						...
						<tr>
							...
							<? while($_dat = mysqli_fetch_assoc($_result)) { ?>
								...
								<? $_xmlPie .= "<set value='" . ($_dat['male']+$_dat['female']) . "' name='" .($_dat['inservice']==""?"ไม่ระบุ":displayInservice($_dat['inservice'])). "' color='" . $_color . "'/>"; ?>
