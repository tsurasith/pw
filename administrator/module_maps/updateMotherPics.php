...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
    <tr> 
    	...
    	<td><strong><font color="#990000" size="4">แผนที่ติดตามที่อยู่</font></strong><br />
			<span class="normal"><font color="#0066FF"><strong>แก้ไขปรับปรุงรูปถ่ายของมารดานักเรียน</strong></font></span></td>
	   <td>&nbsp;</td>
    </tr>
  </table>
<?php
...
<br/>
  ...
  <table class="admintable"  cellpadding="1" cellspacing="1" border="0" align="center" width="100%">
    <tr> 
      	<td class="key" colspan="2">แก้ไขข้อมูลรูปมารดาของนักเรียน</td>
    ...
    <tr>
      ...
      <td>รูปภาพมารดาของนักเรียนที่อัปโหลดควรมีขนาด กว้าง 200 pixel สูง 266 pixel <br/>
