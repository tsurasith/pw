...
<body>
    ...
    <div id="body">
        ...
        <? if(!isset($_REQUEST['option'])) { ?>
            <div id="slogan">ระบบจัดการสารสนเทศเพื่อกำกับ ติดตาม ดูแลช่วยเหลือนักเรียน เพื่อเป้าหมายนักเรียนมีคุณลักษณะที่พึงประสงค์ (Active <?=$number_of_users?> users)</div>
			<div id="cpanel">
