...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
    <tr> 
      ...
      <td ><strong><font color="#990000" size="4">8.00 O' Clock</font></strong><br />
        <span class="normal"><font color="#0066FF"><strong>4.9 แผนภูมิแสดงเปรียบเทียบร้อยละ<br/>ของการเข้าร่วมกิจกรรมหน้าเสาธง(ปีการศึกษา)</strong></font></span></td>
      <td >		
		...
		<table class="admintable" width="100%">
			<tr>
				<th align="center">
					...
					<br/>เปรียบเทียบรายปีการศึกษา<br/>
				</th>
			</tr>
			<tr><td align="center"><div id="chart1" align="center" ></div></td></tr>
			<tr>
				<td align="center">
					<? $_scale = ($_POST['check']=="04"?10:2.5); ?>
					...
					<table class="admintable">
						...
						<? while($dat = mysql_fetch_assoc($resStudent)) { ?>
							...
							<? $_strXML .= "<set name='" . $dat['acadyear'] . "' value='" . number_format($dat['px'],2,'.',',') . "' color='" . getFCColor()  . "' /> "; ?>
						<? } //end while ?>
					</table>
			...
			<tr><td><br/><u>หมายเหตุ</u>: แกน X คือ ปีการศึกษา และ แกน Y คือ ร้อยละ</td></tr>
</table>
