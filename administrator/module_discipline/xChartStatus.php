...
<?php
	if(isset($_POST['search']) && $_POST['level'] != "") {
		...
		if(mysqli_num_rows($_res) > 0) {
			...
			if(isset($_POST['chartType']) == "column"){ $_strXML = $_strXML . "<graph caption='' xAxisName='' yAxisName='Units' decimalPrecision='0' formatNumberScale='0' >"; }
		...
		<table class="admintable" align="center" width="600px">
			...
			<tr>
				...
				<?
					...
					if(isset($_POST['chartType']) == "column") { echo renderChart("../fusionII/charts/Column3D.swf", "", $_strXML , "discipline", 600, 450); }
