...
<?php
	...
	{
		switch($_status){
			case 0 : return  "<a href=\"index.php?option=module_discipline/disciplineFinished&acadyear=$_y&acadsemester=$_s&dis_id=" . $_id . "\">" . $_id . "</a>"; break;
			case 1 : return  "<a href=\"index.php?option=module_discipline/disciplineInvestigate&acadyear=$_y&acadsemester=$_s&dis_id=" . $_id . "\">" . $_id . "</a>"; break;
			...
			case 6 : return  "<a href=\"index.php?option=module_discipline/disciplineFinished&acadyear=$_y&acadsemester=$_s&dis_id=" . $_id . "\">" . $_id . "</a>"; break;
			default : return $_id;
		}
	}
?>