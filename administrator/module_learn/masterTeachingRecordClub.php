		...
		*/
		...
		if(isset($_POST['save'])){
			...
			WHERE
					...
					s.room_id       = '" . $_POST['room_id'] . "' and 
					s.SubjectCode = '" . $_POST['subject_code'] . "' and 
			...
			$_sql_learntable = "
				...
				FROM
					...
					(
						...
						s.room_id      = '000' AND 
						t.teacher_id   IS NOT NULL AND
						s.teaching_date = '" . $_REQUEST['date'] . "'
					)
			WHERE
					t.teacher_id    = '" . $_REQUEST['teacher_id'] . "' and 
					t.club_code     = '" . $_REQUEST['subject'] . "' and 
					t.period        = '" . $_REQUEST['period'] . "' and
					t.club_code    != '0000'
...
<? if($_check_data>0) { ?>
	...
	<div align="center">
	<form method="post" action="index.php?option=module_learn/masterTeachingRecordClub">
