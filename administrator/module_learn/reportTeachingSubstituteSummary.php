...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
    <tr> 
      ...
      <td><strong><font color="#990000" size="4">Room Tracking</font></strong><br />
        <span class="normal"><font color="#0066FF"><strong>3.5 สรุปรายงานการสอนแทน (ครูเจ้าของวิชาเป็นหลัก)</strong></font></span></td>
      <td align="right">
	  <? if(isset($_REQUEST['acadyear'])) { $acadyear = $_REQUEST['acadyear']; }
        ...
        ปีการศึกษา
        <?php  
					echo "<a href=\"index.php?option=module_learn/reportTeachingSubstituteSummary&acadyear=" . ($acadyear - 1) . "\"><img src=\"../images/pull_left.gif\" border=\"0\" /></a> " ;
					echo '<font color=\'blue\'>' .$acadyear . '</font>';
					echo " <a href=\"index.php?option=module_learn/reportTeachingSubstituteSummary&acadyear=" . ($acadyear + 1) . "\"><img src=\"../images/pull_right.gif\" border=\"0\" /></a> " ;
				?>
        ...
        <?php 
					if($acadsemester == 1) { echo "<font color='blue'>1</font> , "; }
						...
						echo " <a href=\"index.php?option=module_learn/reportTeachingSubstituteSummary&acadyear=" . ($acadyear) . "&acadsemester=1 \"> 1</a> , " ;
					}
					if($acadsemester == 2) { echo "<font color='blue'>2</font>"; }
					else {
						echo " <a href=\"index.php?option=module_learn/reportTeachingSubstituteSummary&acadyear=" . ($acadyear) . "&acadsemester=2 \"> 2</a> " ;
					}
				?>
				<br/>
			
		<font  size="2" color="#000000">
			<form action="index.php?option=module_learn/reportTeachingSubstituteSummary" method="post" autocomplete="off">
				เลือกเดือน 
			...
			if($_POST['month']!=""){
				$_sql_display = "
					select 
						...
						concat(u.user_account_firstname,' ',u.user_account_lastname) as 'owner_name',
						t.teaching_date,
						(
							select count(*) 
							...
							where 
								...
								owner_teacher_id = t.owner_teacher_id and
						...
						t.room_id	
					from
						teaching_substitute t left join users_account u on (t.owner_teacher_id = u.user_account_id and t.owner_teacher_id is not null)
						left join users_account o on (t.teacher_id = o.user_account_id and t.teacher_id is not null)
					where
						month(t.teaching_date) = '" . $_POST['month'] ."'
					group by
						owner_name,
						t.teaching_date,
						substitue_teacher,
						room_id
					order by
						convert(owner_name using tis620),
						t.teaching_date
					";
			}else {
				// all semester
				...
				<div align="center">
					...
					<table class="admintable">
						...
						<tr onMouseOver="this.style.backgroundColor='#FFCCFF'; this.style.cursor='hand';" onMouseOut=this.style.backgroundColor="#FFFFFF" >
							...
							<?
								if($_previous_owner!=$_dat['owner_name']){
										echo $_no++;
									}else{ echo ""; }
								?>
							</td>
							...
							<td align="center" valign="top">
								<?
									if($_previous_date != $_dat['teaching_date'] || $_previous_owner!=$_dat['owner_name']){
							...
							<td align="center" valign="top">
								<?php
									if(($_previous_date != $_dat['teaching_date'] || $_previous_owner!=$_dat['owner_name']) && $_previous_total_day != ['total_day']){
										echo $_dat['total_day'];
									}else{ echo ""; }
								?>
							</td>
						...
						<?php
							...
							$_previous_owner     = $_dat['owner_name'];
