...
<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
    <tr> 
      ...
      <td ><strong><font color="#990000" size="4">Room Tracking</font></strong><br />
        <span class="normal"><font color="#0066FF"><strong>4.1 แสดงจำนวนนักเรียนที่เข้าห้องเรียนสาย <br/>แยกตามห้องเรียน [รายเดือน]</strong></font></span></td>
      <td >
		<?php
		...
		?>
		ปีการศึกษา<?php  
					echo "<a href=\"index.php?option=module_learn/xChartRoomMonth&acadyear=" . ($acadyear - 1) . "\"><img src=\"../images/pull_left.gif\" border=\"0\" /></a> " ;
					echo ' <font color=\'blue\'>' .$acadyear . '</font>';
					echo " <a href=\"index.php?option=module_learn/xChartRoomMonth&acadyear=" . ($acadyear + 1) . "\"><img src=\"../images/pull_right.gif\" border=\"0\" /></a> " ;
				?>
		ภาคเรียนที่   <?php 
					if($acadsemester == 1)
					{
					...
					{
						echo " <a href=\"index.php?option=module_learn/xChartRoomMonth&acadyear=" . ($acadyear) . "&acadsemester=1 \"> 1</a> , " ;
					}
					if($acadsemester == 2)
					{
					...
					{
						echo " <a href=\"index.php?option=module_learn/xChartRoomMonth&acadyear=" . ($acadyear) . "&acadsemester=2 \"> 2</a> " ;
					}
				?>
  ...
  <table cellpadding="1" cellspacing="1" border="0" align="center" width="100%">
    ...
    <tr > 
		<th align="center">
	  	...
	  	<br/>แผนภูมิการเข้าห้องเรียนสายของนักเรียนประจำเดือน <?=displayMonth($_POST['month'])?>
