<div id="content">
	<table width="100%"  align="center" border="0" cellspacing="10" cellpadding="0"  class="header">
		...
		<td ><strong><font color="#990000" size="4">Room Tracking</font></strong><br />
			<span class="normal"><font color="#0066FF"><strong>1.3 รายงานประวัติการเข้าห้องเรียน</strong></font></span></td>
		<td >
			ปีการศึกษา
		...
		<?	$_sql = "select check_date,
			...
			<? if(@mysqli_num_rows($_res)>0) { ?>
					...
					<tr> 
						...
						<td class="key" width="230px"  align="center" colspan="2" rowspan="2">วัน/เดือน/ปี</td>
					...
					<tr>
						...
						<td><?='(' . displayDayofWeek(date('w',strtotime($_dat['check_date']))) . ')'?></td>
